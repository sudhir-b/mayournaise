...
Diese Vorlage bietet ein minimales Setup, um React in Vite mit HMR (Hot Module Replacement) und einigen ESLint-Regeln zum Laufen zu bringen.
...
- Konfigurieren Sie die `parserOptions`-Eigenschaft auf oberster Ebene wie folgt:
