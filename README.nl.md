...
Nadat je een project hebt aangemaakt en afhankelijkheden hebt geïnstalleerd met `npm install` (of `pnpm install` of `yarn`), start je een ontwikkelserver:
...
Ga naar de frontend-directory (`cd frontend`).
